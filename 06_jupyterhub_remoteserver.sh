...
[Service]
User=root
Environment="PATH=/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/opt/anaconda/envs/jupyterhub/bin"
ExecStart=/opt/anaconda/envs/jupyterhub/bin/jupyterhub -f /etc/jupyterhub/jupyterhub_config.py
